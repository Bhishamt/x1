    ...
    <div style={{ background: 'var(--bg-primary)', minHeight: '100vh', color: 'var(--text-primary)' }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 760, position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/admissions" className="hero-btn-outline" style={{
      ...
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: '3rem 1.5rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: 'var(--text-secondary)' }}>6 government-approved 3-year diploma engineering programs</p>
        </div>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: '2rem' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
              {['About', 'Admissions', 'Faculty', 'Contact'].map(l => (
